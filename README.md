...
```
    ...
    2022-08-30 06:28:54 — GET https://api.clockify.me/api/v1/workspaces
    ...
    3 630c61ba9c3a3c3112812332 {clockify} sandbox
...
```
    ...
    2022-08-30 06:28:54 — Set active workspace -> 61343c45ab05e02be2c8c1fd.
...
```
    ...
    2022-08-30 06:28:54 — GET https://api.clockify.me/api/v1/user
...
```
    ...
    2022-08-30 06:28:54 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/users
...
```
    ...
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/clients
    2022-08-30 06:28:55 — Page contains 2 results.
    2022-08-30 06:28:55 — API returned 2 results.
...
```
    ...
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/projects
    2022-08-30 06:28:55 — Page contains 2 results.
    2022-08-30 06:28:55 — API returned 2 results.
...
```
    ...
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/user
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-30 06:28:55 — Page contains 8 results.
    2022-08-30 06:28:55 — API returned 8 results.
...
```
    ...
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5ef46293df73063139f60bf5/time-entries
    2022-08-30 06:28:55 — Page contains 2 results.
    2022-08-30 06:28:55 — API returned 2 results.
...
```
    ...
    2022-08-30 06:28:55 — Insert time entry.
    2022-08-30 06:28:55 — POST https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/time-entries
...
```
    ...
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/user
    2022-08-30 06:28:55 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-30 06:28:56 — Page contains 9 results.
    2022-08-30 06:28:56 — API returned 9 results.

    # A tibble: 9 × 4
      id                       description   time_start          time_end           
      <chr>                    <chr>         <dttm>              <dttm>             
    1 630da0174a9a7d448736b220 Prepare for … 2021-08-30 09:00:00 2021-08-30 11:30:00
...
```
    ...
    2022-08-30 06:28:56 — Delete time entry.
    2022-08-30 06:28:56 — DELETE https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/time-entries/630da0174a9a7d448736b220
...
```
    ...
    2022-08-30 06:28:56 — GET https://api.clockify.me/api/v1/user
    2022-08-30 06:28:56 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-30 06:28:56 — Page contains 8 results.
    2022-08-30 06:28:56 — API returned 8 results.
