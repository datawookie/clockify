...
```
    ...
    2022-08-24 16:53:20 — GET https://api.clockify.me/api/v1/workspaces
...
```
    ...
    2022-08-24 16:53:20 — Set active workspace -> 61343c45ab05e02be2c8c1fd.
...
```
    ...
    2022-08-24 16:53:20 — GET https://api.clockify.me/api/v1/user
...
```
    ...
    2022-08-24 16:53:20 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/users
...
```
    ...
    2022-08-24 16:53:20 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/clients
...
```
    ...
    2022-08-24 16:53:20 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/projects
    2022-08-24 16:53:20 — Page contains 2 results.
    2022-08-24 16:53:20 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/projects
    2022-08-24 16:53:20 — Page is empty.
    2022-08-24 16:53:20 — API returned 2 results.
...
```
    ...
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/user
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-24 16:53:21 — Page contains 8 results.
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-24 16:53:21 — Page is empty.
    2022-08-24 16:53:21 — API returned 8 results.
...
```
    ...
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5ef46293df73063139f60bf5/time-entries
    2022-08-24 16:53:21 — Page contains 2 results.
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5ef46293df73063139f60bf5/time-entries
    2022-08-24 16:53:21 — Page is empty.
    2022-08-24 16:53:21 — API returned 2 results.
...
```
    ...
    2022-08-24 16:53:21 — Insert time entry.
    2022-08-24 16:53:21 — POST https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/time-entries
...
```
    ...
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/user
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-24 16:53:21 — Page contains 9 results.
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-24 16:53:21 — Page is empty.
    2022-08-24 16:53:21 — API returned 9 results.

    # A tibble: 9 × 4
      id                       description   time_start          time_end           
      <chr>                    <chr>         <dttm>              <dttm>             
    1 63064971318c063bbd7fa56d Prepare for … 2021-08-30 09:00:00 2021-08-30 11:30:00
...
```
    ...
    2022-08-24 16:53:21 — Delete time entry.
    2022-08-24 16:53:21 — DELETE https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/time-entries/63064971318c063bbd7fa56d
...
```
    ...
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/user
    2022-08-24 16:53:21 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-24 16:53:22 — Page contains 8 results.
    2022-08-24 16:53:22 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-24 16:53:22 — Page is empty.
    2022-08-24 16:53:22 — API returned 8 results.
