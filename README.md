...
```
    ...
    2022-08-29 17:50:33 — GET https://api.clockify.me/api/v1/workspaces
...
```
    ...
    2022-08-29 17:50:33 — Set active workspace -> 61343c45ab05e02be2c8c1fd.
...
```
    ...
    2022-08-29 17:50:33 — GET https://api.clockify.me/api/v1/user
...
```
    ...
    2022-08-29 17:50:33 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/users
...
```
    ...
    2022-08-29 17:50:33 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/clients
    2022-08-29 17:50:33 — Page contains 2 results.
    2022-08-29 17:50:33 — API returned 2 results.
...
```
    ...
    2022-08-29 17:50:33 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/projects
    2022-08-29 17:50:34 — Page contains 2 results.
    2022-08-29 17:50:34 — API returned 2 results.
...
```
    ...
    2022-08-29 17:50:34 — GET https://api.clockify.me/api/v1/user
    2022-08-29 17:50:34 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-29 17:50:34 — Page contains 8 results.
    2022-08-29 17:50:34 — API returned 8 results.
...
```
    ...
    2022-08-29 17:50:34 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5ef46293df73063139f60bf5/time-entries
    2022-08-29 17:50:34 — Page contains 2 results.
    2022-08-29 17:50:34 — API returned 2 results.
...
```
    ...
    2022-08-29 17:50:34 — Insert time entry.
    2022-08-29 17:50:34 — POST https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/time-entries
...
```
    ...
    2022-08-29 17:50:34 — GET https://api.clockify.me/api/v1/user
    2022-08-29 17:50:34 — GET https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/user/5f227e0cd7176a0e6e754409/time-entries
    2022-08-29 17:50:34 — Page contains 9 results.
    2022-08-29 17:50:34 — API returned 9 results.

    # A tibble: 9 × 4
      id                       description   time_start          time_end           
      <chr>                    <chr>         <dttm>              <dttm>             
    1 630cee5a7f07da44c14cae74 Prepare for … 2021-08-30 09:00:00 2021-08-30 11:30:00
...
```
    ...
    2022-08-29 17:50:34 — Delete time entry.
    2022-08-29 17:50:34 — DELETE https://api.clockify.me/api/v1/workspaces/61343c45ab05e02be2c8c1fd/time-entries/630cee5a7f07da44c14cae74
